<?php
// Koneksi database ke database sunset
$conn = new mysqli("localhost", "root", "", "projectelit");  // Ganti 'projectelit' menjadi 'sunset'
...
<body class="bg-gray-100 font-sans antialiased">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="main-content flex-1 flex flex-col transition-all duration-300" id="mainContent">
            ...
            <main class="p-8 bg-gray-50 h-full overflow-y-auto mt-16">
                <h1 class="text-3xl font-bold mb-6 text-blue-600">Daftar Fasilitas Elektronik dan IT</h1>
                ...
                foreach ($facilityGroups as $groupName => $facilities) {
                    ...
                    echo "<h2 class='text-xl font-semibold bg-blue-600 text-white px-4 py-2'>$groupName</h2>";
  ...
  <tr>
    ...
    <th class='border px-4 py-2 text-left text-white bg-purple-500'>Keterangan</th>
                    ...
                    $sql = "SELECT * FROM sunset_facilities 
                ...
                <div class="bg-white shadow-md rounded-lg overflow-hidden mb-8 p-4">
                    <h2 class="text-xl font-semibold text-blue-600 mb-4">Foto Fasilitas</h2>

                    <?php
                    // Query untuk mengambil foto pertama dari fasilitas berdasarkan tanggal
                    $photoSql = "SELECT photo FROM sunset_facilities WHERE DATE(tanggal) = '$selectedDate' LIMIT 1";
